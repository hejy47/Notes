...
1. 开发者补丁中的某些多行补丁实际上也是单行补丁。
2. Purification受弱规约的影响，可能也会导致补丁过拟合。

思路：

1. 测试用例生成：
   1. Identifying Test-Suite-Overfitted Patches through Test Case Generation.
   2. Better test cases for better automated program repair
2. 用concolic testing做测试用例生成。

### 潜在的新的领域

Repairing bugs escaped to the product
